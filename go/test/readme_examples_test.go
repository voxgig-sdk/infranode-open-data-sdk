...
const testSeed = `map[string]any{"entity": map[string]any{"city": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "compare": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "health": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "live": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "meta": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "station": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
