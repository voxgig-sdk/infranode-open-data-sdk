...
func TestCityEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set INFRANODE_OPEN_DATA_TEST_CITY_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func cityBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("INFRANODE_OPEN_DATA_TEST_CITY_ENTID")
	...
	idmapResolved := core.ToMapAny(env["INFRANODE_OPEN_DATA_TEST_CITY_ENTID"])
