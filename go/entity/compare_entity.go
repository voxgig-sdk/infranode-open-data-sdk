...
type CompareEntity struct {
	name    string
	client  *core.InfranodeOpenDataSDK
...
func NewCompareEntity(client *core.InfranodeOpenDataSDK, entopts map[string]any) *CompareEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CompareEntity) GetName() string { return e.name }
...
func (e *CompareEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CompareEntity) Deleted() bool {
	return e.deleted
}


func (e *CompareEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCompareEntity(e.client, opts)
}

func (e *CompareEntity) Data(args ...any) any {
...
func (e *CompareEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Compare; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CompareEntity) DataTyped(data ...Compare) Compare {
	if len(data) > 0 {
		return typedFrom[Compare](e.Data(asMap(data[0])))
	}
	return typedFrom[Compare](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Compare (all fields
// optional at the wire level).
func (e *CompareEntity) MatchTyped(match ...Compare) Compare {
	if len(match) > 0 {
		return typedFrom[Compare](e.Match(asMap(match[0])))
	}
	return typedFrom[Compare](e.Match())
}
...
func (e *CompareEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CompareEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CompareEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CompareListMatch and returns []Compare. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CompareEntity) ListTyped(reqmatch CompareListMatch, ctrl map[string]any) ([]Compare, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Compare](res), nil
}



func (e *CompareEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CompareEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CompareEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CompareEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
