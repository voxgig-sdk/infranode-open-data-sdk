...
func NewLiveEntity(client *core.InfranodeOpenDataSDK, entopts map[string]any) *LiveEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LiveEntity) GetName() string { return e.name }
...
func (e *LiveEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LiveEntity) Deleted() bool {
	return e.deleted
}


func (e *LiveEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLiveEntity(e.client, opts)
}

func (e *LiveEntity) Data(args ...any) any {
...
func (e *LiveEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Live; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LiveEntity) DataTyped(data ...Live) Live {
	if len(data) > 0 {
		return typedFrom[Live](e.Data(asMap(data[0])))
	}
	return typedFrom[Live](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Live (all fields
// optional at the wire level).
func (e *LiveEntity) MatchTyped(match ...Live) Live {
	if len(match) > 0 {
		return typedFrom[Live](e.Match(asMap(match[0])))
	}
	return typedFrom[Live](e.Match())
}
...
func (e *LiveEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LiveEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LiveLoadMatch and returns an Live. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LiveEntity) LoadTyped(reqmatch LiveLoadMatch, ctrl map[string]any) (Live, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Live{}, err
	}
	return typedFrom[Live](res), nil
}



func (e *LiveEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LiveEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LiveEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LiveEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LiveEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
