...
#      offline in seeded test mode (InfranodeOpenDataSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "InfranodeOpenData_sdk.rb")
  SDK_CLASS = "InfranodeOpenDataSDK"
  ...
  SDK_BASE = "InfranodeOpenData_sdk"
