...
class CityEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set INFRANODEOPENDATA_TEST_CITY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
    ...
    assert !city_ref01_data_dt0_loaded.nil?
...
def city_basic_setup(extra)
  ...
  entid_env_raw = ENV["INFRANODEOPENDATA_TEST_CITY_ENTID"]
