...
class CityEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set INFRANODE_OPEN_DATA_TEST_CITY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def city_basic_setup(extra)
  ...
  entid_env_raw = ENV["INFRANODE_OPEN_DATA_TEST_CITY_ENTID"]
