...
require_relative 'InfranodeOpenData_types'
...
class InfranodeOpenDataSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = InfranodeOpenDataHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = InfranodeOpenDataHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, InfranodeOpenDataFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    InfranodeOpenDataUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = InfranodeOpenDataHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = InfranodeOpenDataHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = InfranodeOpenDataHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
    ...
    ctx.spec = InfranodeOpenDataSpec.new({
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => InfranodeOpenDataError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue InfranodeOpenDataError => err
    ...
    if fetched.is_a?(Hash)
      status = InfranodeOpenDataHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = InfranodeOpenDataError.new(
        "graphql_error", "InfranodeOpenDataSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  # Canonical facade: client.Compare.list / client.Compare.load({ "id" => ... })
  def Compare(data = nil)
    require_relative 'entity/compare_entity'
    CompareEntity.new(self, data)
  end
  ...
  # Canonical facade: client.Live.list / client.Live.load({ "id" => ... })
  def Live(data = nil)
    require_relative 'entity/live_entity'
    LiveEntity.new(self, data)
  end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = InfranodeOpenDataSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
