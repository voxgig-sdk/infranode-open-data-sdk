# InfranodeOpenData SDK Meta entity
...
class MetaEntity
  ...
  # @return [Meta, Hash] the loaded Meta; raises InfranodeOpenDataError on failure
  ...
  #
  # @param reqmatch [MetaListMatch, Hash, nil] match filter (any subset of
  #   Meta fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Meta>, Array] the matching Meta items; raises InfranodeOpenDataError on failure
