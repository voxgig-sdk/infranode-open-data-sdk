# InfranodeOpenData SDK City entity
...
class CityEntity
  ...
  # @return [City, Hash] the loaded City; raises InfranodeOpenDataError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<City>, Array] the matching City items; raises InfranodeOpenDataError on failure
