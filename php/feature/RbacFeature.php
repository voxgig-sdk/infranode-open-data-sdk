...
// InfranodeOpenData SDK rbac feature
...
class InfranodeOpenDataRbacFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _required(InfranodeOpenDataContext $ctx): ?string
    {
    ...
    private function _reject(InfranodeOpenDataContext $ctx, string $required): void
    {
    ...
    private function _track(InfranodeOpenDataContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
