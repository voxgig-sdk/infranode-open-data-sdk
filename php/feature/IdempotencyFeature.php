...
// InfranodeOpenData SDK idempotency feature
...
class InfranodeOpenDataIdempotencyFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _mutating(InfranodeOpenDataContext $ctx): bool
    {
