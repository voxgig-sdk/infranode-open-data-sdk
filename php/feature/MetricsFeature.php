...
// InfranodeOpenData SDK metrics feature
...
class InfranodeOpenDataMetricsFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _record(InfranodeOpenDataContext $ctx, bool $ok): void
    {
