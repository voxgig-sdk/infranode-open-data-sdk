...
// InfranodeOpenData SDK audit feature
...
class InfranodeOpenDataAuditFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _emit(InfranodeOpenDataContext $ctx, string $outcome): void
    {
