...
// InfranodeOpenData SDK clienttrack feature
...
class InfranodeOpenDataClienttrackFeature extends InfranodeOpenDataBaseFeature
{
    ...
    public function PostConstruct(InfranodeOpenDataContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'InfranodeOpenData-SDK';
