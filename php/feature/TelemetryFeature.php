...
// InfranodeOpenData SDK telemetry feature
...
class InfranodeOpenDataTelemetryFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _close(InfranodeOpenDataContext $ctx, bool $ok): void
    {
