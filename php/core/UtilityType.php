...
// InfranodeOpenData SDK utility type

class InfranodeOpenDataUtility
{
    ...
    public static function copy(InfranodeOpenDataUtility $src): InfranodeOpenDataUtility
    {
        $u = new InfranodeOpenDataUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
