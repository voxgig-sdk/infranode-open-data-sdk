...
// InfranodeOpenData SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (InfranodeOpenDataSDK::test)
...
{
    private const SDK_CLASS = 'InfranodeOpenDataSDK';
    ...
    private const SDK_BASE = 'infranodeopendata_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../infranodeopendata_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
