...
// InfranodeOpenData SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = InfranodeOpenDataOmni::makeStructRunner(
    ...
    {
        return InfranodeOpenDataOmni::objmodel(InfranodeOpenDataOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return InfranodeOpenDataOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return InfranodeOpenDataOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(InfranodeOpenDataOmni::structfix($now, Struct::undef()))
                        !== json_encode(InfranodeOpenDataOmni::structfix($val, Struct::undef()))) {
