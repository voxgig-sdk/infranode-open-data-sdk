...
class HealthEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set INFRANODE_OPEN_DATA_TEST_HEALTH_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function health_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("INFRANODE_OPEN_DATA_TEST_HEALTH_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["INFRANODE_OPEN_DATA_TEST_HEALTH_ENTID"]);
