...
// InfranodeOpenData SDK pipeline test
//
...
{
    private static function utility(): InfranodeOpenDataUtility
    {
        return new InfranodeOpenDataUtility();
    }
    ...
    private static function ctx(array $over = []): InfranodeOpenDataContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new InfranodeOpenDataContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new InfranodeOpenDataOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof InfranodeOpenDataError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new InfranodeOpenDataOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = InfranodeOpenDataMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new InfranodeOpenDataOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = InfranodeOpenDataMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new InfranodeOpenDataOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = InfranodeOpenDataMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new InfranodeOpenDataSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = InfranodeOpenDataMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new InfranodeOpenDataResponse([]),
            'result' => new InfranodeOpenDataResult([]),
        ]);
        [, $err] = InfranodeOpenDataMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new InfranodeOpenDataSpec([]),
            'response' => null,
            'result' => new InfranodeOpenDataResult([]),
        ]);
        [, $err] = InfranodeOpenDataMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new InfranodeOpenDataSpec(['step' => 's']),
            'response' => new InfranodeOpenDataResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new InfranodeOpenDataResult([]),
        ]);
        [, $err] = InfranodeOpenDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new InfranodeOpenDataSpec(['step' => 's']),
            'response' => new InfranodeOpenDataResponse(self::resp(200, ['v' => 1])),
            'result' => new InfranodeOpenDataResult([]),
        ]);
        [, $err] = InfranodeOpenDataMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new InfranodeOpenDataSpec(['step' => 's']),
            'response' => new InfranodeOpenDataResponse(self::resp(200, ['v' => 2])),
            'result' => new InfranodeOpenDataResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        InfranodeOpenDataMakeResponse::call($ctx);
    ...
    {
        $preset = new InfranodeOpenDataResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new InfranodeOpenDataSpec([]),
            'response' => new InfranodeOpenDataResponse([]),
            'result' => new InfranodeOpenDataResult([]),
        ...
        [$got, $err] = InfranodeOpenDataMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new InfranodeOpenDataResult([])]);
        [, $err] = InfranodeOpenDataMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new InfranodeOpenDataSpec([]), 'result' => null]);
        [, $err] = InfranodeOpenDataMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new InfranodeOpenDataSpec(['step' => 's']),
            'result' => new InfranodeOpenDataResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new InfranodeOpenDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = InfranodeOpenDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new InfranodeOpenDataSpec(['step' => 's']),
            'result' => new InfranodeOpenDataResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new InfranodeOpenDataOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = InfranodeOpenDataMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new InfranodeOpenDataResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new InfranodeOpenDataSpec([]),
            'result' => new InfranodeOpenDataResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = InfranodeOpenDataMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = InfranodeOpenDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new InfranodeOpenDataError('boom', 'boom');
        $utility->fetcher = function (InfranodeOpenDataContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new InfranodeOpenDataSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = InfranodeOpenDataMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (InfranodeOpenDataContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = InfranodeOpenDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(InfranodeOpenDataResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        InfranodeOpenDataMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (InfranodeOpenDataContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new InfranodeOpenDataSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = InfranodeOpenDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new InfranodeOpenDataResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new InfranodeOpenDataSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = InfranodeOpenDataMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = InfranodeOpenDataMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = InfranodeOpenDataMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new InfranodeOpenDataResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, InfranodeOpenDataDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new InfranodeOpenDataResult(['ok' => false])]);
        $this->expectException(InfranodeOpenDataError::class);
        InfranodeOpenDataDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new InfranodeOpenDataResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', InfranodeOpenDataMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        InfranodeOpenDataMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new InfranodeOpenDataBaseFeature();
        $b = new InfranodeOpenDataBaseFeature();
        InfranodeOpenDataFeatureAdd::call($ctx, $a);
        InfranodeOpenDataFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): InfranodeOpenDataBaseFeature
    {
        $f = new InfranodeOpenDataBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        InfranodeOpenDataFeatureAdd::call($ctx, self::named_feature('a'));
        InfranodeOpenDataFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        InfranodeOpenDataFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        InfranodeOpenDataFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        InfranodeOpenDataFeatureAdd::call($ctx, $replace);
        ...
        InfranodeOpenDataFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): InfranodeOpenDataContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new InfranodeOpenDataSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = InfranodeOpenDataPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        InfranodeOpenDataPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new InfranodeOpenDataResponse(['headers' => null]),
            'result' => new InfranodeOpenDataResult([]),
        ]);
        InfranodeOpenDataResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        InfranodeOpenDataResultBody::call($ctx);
