...
// InfranodeOpenData SDK Live entity
...
class LiveEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new LiveEntity($this->_client, $opts);
    }

    /**
     * @param Live|array $args Live data (assoc-array) to store.
     */
    ...
    /**
     * @return Live|array The current Live data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Live fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Live fields).
     */
     ...
     * Load a single Live.
     *
     * @param LiveLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed LiveLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Live|array The loaded Live as an assoc-array at the
     *   SDK boundary; throws InfranodeOpenDataError on failure (item-5 convention).
     */
        ...
        return $this->_run_op($ctx, function () use ($ctx) {
            if ($ctx->result) {
                ...
                if ($ctx->result->resdata) {
                    $this->_data = InfranodeOpenDataHelpers::to_map(Struct::clone($ctx->result->resdata)) ?? [];
                }
            }
        });
    }
