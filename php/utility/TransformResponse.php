...
// InfranodeOpenData SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class InfranodeOpenDataTransformResponse
{
    public static function call(InfranodeOpenDataContext $ctx): mixed
    {
        ...
        $transform = InfranodeOpenDataHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
