...
// InfranodeOpenData SDK utility: result_basic

class InfranodeOpenDataResultBasic
{
    public static function call(InfranodeOpenDataContext $ctx): ?InfranodeOpenDataResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof InfranodeOpenDataError) ? $result->err->msg : (string)$result->err;
