...
// InfranodeOpenData SDK utility: graphql
//
...
class InfranodeOpenDataGraphql
{
    ...
    // equivalent.
    public static function body(InfranodeOpenDataContext $ctx): mixed
    {
    ...
    public static function errors(InfranodeOpenDataContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
