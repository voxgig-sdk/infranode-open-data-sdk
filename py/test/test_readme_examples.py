# InfranodeOpenData SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions InfranodeOpenDataSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both InfranodeOpenDataSDK(...) and InfranodeOpenDataSDK.test(...) become
#      InfranodeOpenDataSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "infranodeopendata_sdk"
_SDK_CLASS = "InfranodeOpenDataSDK"
