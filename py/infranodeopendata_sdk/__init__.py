...
from infranodeopendata_sdk.utility import register

# Load features
from infranodeopendata_sdk.feature.base_feature import InfranodeOpenDataBaseFeature
from infranodeopendata_sdk.features import _has_feature, _make_feature
...
class InfranodeOpenDataSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = InfranodeOpenDataUtility()
        self._utility = utility

        from infranodeopendata_sdk.config import shared_config
    ...
    def get_utility(self):
        return InfranodeOpenDataUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("InfranodeOpenDataSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def City(self, data=None) -> "CityEntity":
        ...
        from infranodeopendata_sdk.entity.city_entity import CityEntity
    ...
    def Compare(self, data=None) -> "CompareEntity":
        ...
        from infranodeopendata_sdk.entity.compare_entity import CompareEntity
    ...
    def Health(self, data=None) -> "HealthEntity":
        ...
        from infranodeopendata_sdk.entity.health_entity import HealthEntity
        return HealthEntity(self, data)


    def Live(self, data=None) -> "LiveEntity":
        """Entity factory: client.Live().list() / client.Live().load({"id": ...})."""
        from infranodeopendata_sdk.entity.live_entity import LiveEntity
        return LiveEntity(self, data)


    def Meta(self, data=None) -> "MetaEntity":
        """Entity factory: client.Meta().list() / client.Meta().load({"id": ...})."""
        from infranodeopendata_sdk.entity.meta_entity import MetaEntity
    ...
    def Station(self, data=None) -> "StationEntity":
        ...
        from infranodeopendata_sdk.entity.station_entity import StationEntity
        return StationEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "InfranodeOpenDataSDK":
        if sdkopts is None:
            sdkopts = {}
