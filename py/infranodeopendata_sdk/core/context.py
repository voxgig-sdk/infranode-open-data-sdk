...
from infranodeopendata_sdk.core.control import InfranodeOpenDataControl
...
from infranodeopendata_sdk.core.helpers import get_ctx_prop, to_map
...
class InfranodeOpenDataContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = InfranodeOpenDataControl()
        ...
        if isinstance(sp, InfranodeOpenDataSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, InfranodeOpenDataResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, InfranodeOpenDataResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return InfranodeOpenDataOperation({})
    ...
    def make_error(self, code, msg):
        return InfranodeOpenDataError(code, msg, self)
