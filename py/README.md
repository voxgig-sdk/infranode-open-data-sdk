# InfranodeOpenData Python SDK



The Python SDK for the InfranodeOpenData API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/infranode-open-data-sdk/releases)) or
...
```python
compares = client.Compare().list({"city": "example", "resource": "example"})
```
