...
class InfranodeOpenDataTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = InfranodeOpenDataTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = InfranodeOpenDataTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = InfranodeOpenDataTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
