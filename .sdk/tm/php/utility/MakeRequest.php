...
// InfranodeOpenData SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class InfranodeOpenDataMakeRequest
{
    public static function call(InfranodeOpenDataContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new InfranodeOpenDataResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new InfranodeOpenDataResponse($fetched);
        } else {
