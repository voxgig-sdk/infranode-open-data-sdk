...
// InfranodeOpenData SDK utility: fetcher

class InfranodeOpenDataFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; InfranodeOpenDataSDK/1.0)';
    ...
    public static function call(InfranodeOpenDataContext $ctx, string $fullurl, array $fetchdef): array
    {
