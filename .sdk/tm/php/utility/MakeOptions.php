...
// InfranodeOpenData SDK utility: make_options

class InfranodeOpenDataMakeOptions
{
    ...
    public static function call(InfranodeOpenDataContext $ctx): array
    {
        ...
        //
        // `InfranodeOpenDataSchema::optspec()` is built from the model:
        ...
        $optspec = InfranodeOpenDataSchema::optspec();
