...
// InfranodeOpenData SDK proxy feature
...
class InfranodeOpenDataProxyFeature extends InfranodeOpenDataBaseFeature
{
    ...
    public function init(InfranodeOpenDataContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (InfranodeOpenDataContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
