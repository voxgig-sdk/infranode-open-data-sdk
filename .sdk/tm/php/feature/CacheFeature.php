...
// InfranodeOpenData SDK cache feature
...
class InfranodeOpenDataCacheFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _through(InfranodeOpenDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
