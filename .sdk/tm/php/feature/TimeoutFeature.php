...
// InfranodeOpenData SDK timeout feature
...
class InfranodeOpenDataTimeoutFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _with_timeout(InfranodeOpenDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(InfranodeOpenDataContext $_ctx, float $ms): void
    {
        $client = $this->client;
