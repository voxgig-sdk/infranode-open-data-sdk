...
// InfranodeOpenData SDK netsim feature
...
class InfranodeOpenDataNetsimFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _simulate(InfranodeOpenDataContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(InfranodeOpenDataContext $ctx, array $applied): void
    {
        $client = $this->client;
