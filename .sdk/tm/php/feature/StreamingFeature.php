...
// InfranodeOpenData SDK streaming feature
...
class InfranodeOpenDataStreamingFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _iterate(InfranodeOpenDataResult $result): \Generator
    {
    ...
    private function _streamable(InfranodeOpenDataContext $ctx): bool
    {
