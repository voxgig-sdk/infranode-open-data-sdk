...
// InfranodeOpenData SDK ratelimit feature
...
class InfranodeOpenDataRatelimitFeature extends InfranodeOpenDataBaseFeature
{
    ...
    private function _acquire(InfranodeOpenDataContext $ctx): void
    {
    ...
    private function _track(InfranodeOpenDataContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
