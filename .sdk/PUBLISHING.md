...
|---|---|---|
| `ts/` | @voxgig-sdk/infranode-open-data-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/infranode-open-data-sdk \
      --repository voxgig-sdk/infranode-open-data-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/infranode-open-data-sdk` shows it, and
`npm trust revoke @voxgig-sdk/infranode-open-data-sdk --id=<id>` removes it.
