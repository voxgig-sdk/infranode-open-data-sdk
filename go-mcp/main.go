// Command InfranodeOpenData-mcp is an MCP server exposing the InfranodeOpenData
// SDK as MCP tools.
//
// Two tools are registered:
//
//	InfranodeOpenData_list  — list records of an entity
//	InfranodeOpenData_load  — load a single record of an entity
//
