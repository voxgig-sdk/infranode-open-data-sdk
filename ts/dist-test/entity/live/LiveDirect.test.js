...
(0, node_test_1.describe)('LiveDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.InfranodeOpenDataSDK({
    ...
    (0, node_test_1.test)('direct-load-live', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-live', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["live_id01", "route_id01"]))
            return;
...
function liveScenariosActive() { return false && process.env.INFRANODE_OPEN_DATA_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.InfranodeOpenDataSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['INFRANODE_OPEN_DATA_TEST_LIVE_ENTID'];
    ...
    const client = new __1.InfranodeOpenDataSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=LiveDirect.test.js.map