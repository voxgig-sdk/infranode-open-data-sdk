...
function basicSetup(extra) {
    ...
    let idmap = transform(['station01', 'station02', 'station03', 'station01', 'station02', 'station03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['INFRANODE_OPEN_DATA_TEST_STATION_ENTID'];
    ...
    idmap = env['INFRANODE_OPEN_DATA_TEST_STATION_ENTID'];
