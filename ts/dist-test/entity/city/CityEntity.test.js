...
function basicSetup(extra) {
    ...
    let idmap = transform(['city01', 'city02', 'city03', 'city01', 'city02', 'city03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['INFRANODE_OPEN_DATA_TEST_CITY_ENTID'];
    ...
    idmap = env['INFRANODE_OPEN_DATA_TEST_CITY_ENTID'];
