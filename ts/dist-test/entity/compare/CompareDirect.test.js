...
(0, node_test_1.describe)('CompareDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-compare', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-compare', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
        if (setup.live) {
            query.city = "berlin,koeln,hamburg";
        }
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['INFRANODE_OPEN_DATA_TEST_COMPARE_ENTID'];
...
//# sourceMappingURL=CompareDirect.test.js.map