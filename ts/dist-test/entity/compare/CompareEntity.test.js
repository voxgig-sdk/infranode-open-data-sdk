...
(0, node_test_1.describe)('CompareEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'compare.' + op, live))
                return;
        }
        ...
        const compare_ref01_match = {};
        const compare_ref01_list = (await compare_ref01_ent.list(compare_ref01_match)).map((e) => e.data());
    });
});
function basicSetup(extra) {
    ...
    const idmapEnvVal = process.env['INFRANODE_OPEN_DATA_TEST_COMPARE_ENTID'];
