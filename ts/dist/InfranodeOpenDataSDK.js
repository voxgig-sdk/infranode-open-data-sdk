...
exports.SDK = exports.InfranodeOpenDataSDK = exports.InfranodeOpenDataEntityBase = exports.BaseFeature = exports.config = exports.stdutil = void 0;
const CityEntity_1 = require("./entity/CityEntity");
const CompareEntity_1 = require("./entity/CompareEntity");
const HealthEntity_1 = require("./entity/HealthEntity");
const LiveEntity_1 = require("./entity/LiveEntity");
...
Object.defineProperty(exports, "InfranodeOpenDataEntityBase", { enumerable: true, get: function () { return InfranodeOpenDataEntityBase_1.InfranodeOpenDataEntityBase; } });
...
class InfranodeOpenDataSDK {
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('InfranodeOpenDataSDK: graphql: ' +
    ...
    Compare(entopts) {
        const self = this;
        return new CompareEntity_1.CompareEntity(self, entopts);
    }
    ...
    Live(entopts) {
        const self = this;
        return new LiveEntity_1.LiveEntity(self, entopts);
    }
...
exports.InfranodeOpenDataSDK = InfranodeOpenDataSDK;
const SDK = InfranodeOpenDataSDK;
exports.SDK = SDK;
//# sourceMappingURL=InfranodeOpenDataSDK.js.map