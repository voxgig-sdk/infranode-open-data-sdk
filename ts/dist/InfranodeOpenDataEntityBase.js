...
exports.InfranodeOpenDataEntityBase = void 0;
const node_util_1 = require("node:util");
// TODO: needs Entity superclass
// `D` is the entity's typed data model (e.g. Advice); subclasses bind it via
// `class AdviceEntity extends InfranodeOpenDataEntityBase<Advice>`.
class InfranodeOpenDataEntityBase {
    name = '';
    name_ = '';
    Name = '';
    _client;
...
exports.InfranodeOpenDataEntityBase = InfranodeOpenDataEntityBase;
//# sourceMappingURL=InfranodeOpenDataEntityBase.js.map