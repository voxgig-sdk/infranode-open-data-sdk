...
func registerSDKWords(r *eng.Registry, client *sdk.InfranodeOpenDataSDK) {
...
func runOp(client *sdk.InfranodeOpenDataSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
