...
describe("CompareDirect", function()
  it("should direct-list-compare", function()
    local setup = compare_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-compare", setup.live and "live" or "unit")
