...
describe("LiveDirect", function()
  it("should direct-load-live", function()
    local setup = live_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-live", setup.live and "live" or "unit")
