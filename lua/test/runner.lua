...
function runner.env_override(m)
  local live = runner.getenv("INFRANODE_OPEN_DATA_TEST_LIVE")
  local override = runner.getenv("INFRANODE_OPEN_DATA_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("INFRANODE_OPEN_DATA_TEST_EXPLAIN")
