...
local function make_error_util(ctx, err)
  ...
  local msg = "InfranodeOpenDataSDK: " .. opname .. ": " .. errmsg
  ...
  local sdk_err = InfranodeOpenDataError.new("", msg, ctx)
  ...
  if type(err) == "table" and getmetatable(err) == InfranodeOpenDataError then
